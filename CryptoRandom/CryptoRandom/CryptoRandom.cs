...
public class CryptoRandom : ICryptoRandom
{
  ...
  private sealed class TSCryptoRandom : CryptoRandom
  {
    ...
    /// </summary>
    /// <returns></returns>
    private new static string ToAuthor()
    {
      var sb = new StringBuilder();
      sb.AppendLine("© CryptoRandom 2017");
      sb.AppendLine("Created by © Michele Natale 2017");
    ...
    /// <returns>Datatype bool</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public override bool NextCryptoBool()
    {
      return (this.NextCryptoByte() & 1) == 0;
    }
    ...
    /// <param name="dest">Buffer</param>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public override void FillCryptoBools(bool[] dest)
    {
      var dl = (dest.Length - 1) / 32 + 1;
      var ints = new int[dl];
      this.FillCryptoInts<int>(ints);
    ...
    /// <returns>Datatype bool</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public override bool[] RngCryptoBools(int size)
    {
      var result = new bool[size];
      this.FillCryptoBools(result);
      return result;
    ...
    /// <returns>Datatype Byte</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public override byte NextCryptoByte(byte max)
    {
      return this.RngInts(1, byte.MinValue, max).First();
    }
    ...
    /// <returns>Datatype Byte</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public override byte NextCryptoByte(byte min, byte max)
    {
      return this.RngInts(1, min, max).First();
    }
    ...
    /// <returns>Array of byte</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public override byte[] RngCryptoBytes(int size, byte min, byte max)
    {
      return this.RngInts(size, min, max);
    }
    ...
    /// <param name="max">Upper limit</param>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public override void FillCryptoBytes(Span<byte> bytes, byte min, byte max)
    {
      var result = new byte[bytes.Length];
      this.RngInts(result, min, max);
      result.CopyTo(bytes);
    ...
    /// <returns>Datatype Generic T</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public override T NextCryptoInt<T>()
    {
      return this.RngInts(1, T.Zero, T.MaxValue).First();
    }
    ...
    /// <returns>Datatype Generic T</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public override T NextCryptoInt<T>(T max)
    {
      return this.NextCryptoInt(T.Zero, max);
    }
    ...
    /// <returns>Datatype generic T</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public override T NextCryptoInt<T>(T min, T max)
    {
      return this.RngInts(1, min, max).First();
    }
    ...
    /// <returns>Datatype Generic T</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public override T[] RngCryptoInts<T>(int size)
    {
      return this.RngInts(size, T.Zero, T.MaxValue);
    }
    ...
    /// <returns>Datatype Generic T</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public override T[] RngCryptoInts<T>(int size, T max)
    {
      return this.RngInts(size, T.Zero, max);
    }
    ...
    /// <returns>Datatype Generic T</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public override T[] RngCryptoInts<T>(int size, T min, T max)
    {
      return this.RngInts(size, min, max);
    }
    ...
    /// <param name="ints">Buffer</param>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public override void FillCryptoInts<T>(Span<T> ints)
    {
      var result = this.RngInts(ints.Length, T.Zero, T.MaxValue);
      result.CopyTo(ints);
    }
    ...
    /// <param name="max">Upper Limit</param>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public override void FillCryptoInts<T>(Span<T> ints, T max)
    {
      this.FillCryptoInts(ints, T.Zero, max);
    }
    ...
    /// <param name="max">Upper Limit</param>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public override void FillCryptoInts<T>(Span<T> ints, T min, T max)
    {
      var result = this.RngInts(ints.Length, min, max);
      result.CopyTo(ints);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private new T[] RngInts<T>(int size, T min, T max)
      where T : INumber<T>, INumberBase<T>
    {
      if (size == 0) return [];
      var result = new T[size];
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private new unsafe void RngInts<T>(T[] ints, T min, T max)
      where T : INumber<T>, INumberBase<T>
    {
      if (IsNullOrEmpty(ints)) return;
      ArgumentOutOfRangeException.ThrowIfGreaterThanOrEqual(min, max);
    ...
    /// <returns>Datatype String</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public override string NextString(int count, string alphabet)
    {
      var sb = new StringBuilder(count);
    ...
    /// <returns>Datatype Double</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public override double NextCryptoDouble()
    {
      // Multiplier equals 0x1.0p-53, or as 64 bits: 0x3CA0000000000000
      return (this.NextCryptoInt<ulong>() >> 11) * 1.1102230246251565E-16;
    }
    ...
    /// <exception cref="ArgumentOutOfRangeException"></exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public override double NextCryptoDouble(double min, double max)
    {
      if (max > min)
        return min + this.NextCryptoDouble() * (max - min);
      throw new ArgumentOutOfRangeException(nameof(max), "Out of range");
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public override double[] RngCryptoDouble(int size)
    {
      var result = new double[size];
      this.FillCryptoDoubles(result);
      return result;
    ...
    /// <returns>Datatype Double</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public override double[] RngCryptoDouble(int size, double max)
    {
      return this.RngCryptoDouble(size, 0.0, max);
    }
    ...
    /// <returns>Datatype Double</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public override double[] RngCryptoDouble(int size, double min, double max)
    {
      var result = new double[size];
      this.FillCryptoDoubles(result, min, max);
      return result;
    ...
    /// <param name="dest">Buffer</param>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public override void FillCryptoDoubles(double[] dest)
    {
      var uls = new ulong[dest.Length];
      this.FillCryptoInts<ulong>(uls);
    ...
    /// <param name="max">Upper Limit</param>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public override void FillCryptoDoubles(double[] dest, double max)
    {
      this.FillCryptoDoubles(dest, 0.0, max);
    }
    ...
    /// <exception cref="ArgumentOutOfRangeException"></exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public override void FillCryptoDoubles(double[] dest, double min, double max)
    {
      if (max > min)
      {
        this.FillCryptoDoubles(dest);
    ...
    /// <param name="str">The String</param>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public override void Shuffle(ref string str)
    {
      if (str.Length > 1)
      {
        var arr = str.ToCharArray();
    ...
    /// <param name="items">Buffer of Generic Type T</param>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public override void Shuffle<T>(T[] items) => this.Shuffle(items, 0, -1);
    ...
    /// <param name="count">Number of Count</param>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public override void Shuffle<T>(T[] items, int offset, int count)
    {
      // Fisher-Yates algorithm
      count = AssertBounds(items.Length, offset, count);
    ...
    /// <param name="items">List of generic Type T</param>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public override void Shuffle<T>(IList<T> items) => this.Shuffle(items, 0, -1);
    ...
    /// <param name="count">Number of Count</param>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public override void Shuffle<T>(IList<T> items, int offset, int count)
    {
      // Fisher-Yates algorithm
      count = AssertBounds(items.Count, offset, count);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private new static bool IsNullOrEmpty<T>(T[] ints)
      where T : INumber<T>, INumberBase<T>
    {
      if (ints is null) return true;
      return ints.Length == 0;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private new static int AssertBounds(int length, int offset, int count)
    {
      if (offset >= length || offset < 0)
      {
        if (offset == 0 && count <= 0)
