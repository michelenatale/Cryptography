...
public class CryptoRandom : ICryptoRandom
{
  ...
  [MethodImpl(MethodImplOptions.AggressiveInlining)]
  public void FillCryptoBools(bool[] dest)
  {
  ...
  /// <returns>Datatype bool</returns>
  [MethodImpl(MethodImplOptions.AggressiveInlining)]
  public bool[] RngCryptoBools(int size)
  {
  ...
  [MethodImpl(MethodImplOptions.AggressiveInlining)]
  public byte NextCryptoByte(bool no_zeros = true)
  {
  ...
  /// <returns>Datatype Byte</returns>
  [MethodImpl(MethodImplOptions.AggressiveInlining)]
  public byte NextCryptoByte(byte max)
  {
  ...
  /// <returns>Datatype Byte</returns>
  [MethodImpl(MethodImplOptions.AggressiveInlining)]
  public byte NextCryptoByte(byte min, byte max)
  {
  ...
  /// <returns>Datatype Byte</returns>
  [MethodImpl(MethodImplOptions.AggressiveInlining)]
  public byte[] RngCryptoBytes(int size, bool no_zeros = true)
  {
  ...
  [MethodImpl(MethodImplOptions.AggressiveInlining)]
  public byte[] RngCryptoBytes(int size, byte min, byte max)
  {
  ...
  /// <param name="no_zeros">Selection with or without zeros</param>
  [MethodImpl(MethodImplOptions.AggressiveInlining)]
  public void FillCryptoBytes(Span<byte> bytes, bool no_zeros = true)
  {
  ...
  /// <param name="max">Upper limit</param>
  [MethodImpl(MethodImplOptions.AggressiveInlining)]
  public void FillCryptoBytes(Span<byte> bytes, byte min, byte max)
  {
  ...
  /// <returns>Datatype Generic T</returns>
  [MethodImpl(MethodImplOptions.AggressiveInlining)]
  public T NextCryptoInt<T>(T max)
  ...
  /// <returns>Datatype generic T</returns>
  [MethodImpl(MethodImplOptions.AggressiveInlining)]
  public T NextCryptoInt<T>(T min, T max)
    where T : INumber<T>, INumberBase<T>
  {
    return this.RngInts(1, min, max).First();
  }
  ...
  /// <returns>Datatype Generic T</returns>
  [MethodImpl(MethodImplOptions.AggressiveInlining)]
  public T[] RngCryptoInts<T>(int size)
    where T : INumber<T>, INumberBase<T>, IMinMaxValue<T>
  {
  ...
  /// <returns>Datatype Generic T</returns>
  [MethodImpl(MethodImplOptions.AggressiveInlining)]
  public T[] RngCryptoInts<T>(int size, T max)
    where T : INumber<T>, INumberBase<T>
  {
  ...
  /// <returns>Datatype Generic T</returns>
  [MethodImpl(MethodImplOptions.AggressiveInlining)]
  public T[] RngCryptoInts<T>(int size, T min, T max)
    where T : INumber<T>, INumberBase<T>
  {
    return this.RngInts(size, min, max);
  }
  ...
  [MethodImpl(MethodImplOptions.AggressiveInlining)]
  public void FillCryptoInts<T>(Span<T> ints)
    where T : INumber<T>, INumberBase<T>, IMinMaxValue<T>
  {
  ...
  /// <param name="max">Upper Limit</param>
  [MethodImpl(MethodImplOptions.AggressiveInlining)]
  public void FillCryptoInts<T>(Span<T> ints, T max)
    where T : INumber<T>, INumberBase<T>
  {
  ...
  /// <param name="max">Upper Limit</param>
  [MethodImpl(MethodImplOptions.AggressiveInlining)]
  public void FillCryptoInts<T>(Span<T> ints, T min, T max)
    where T : INumber<T>, INumberBase<T>
  {
  ...
  [MethodImpl(MethodImplOptions.AggressiveInlining)]
  public double NextCryptoDouble()
  {
  ...
  [MethodImpl(MethodImplOptions.AggressiveInlining)]
  public double NextCryptoDouble(double min, double max)
  {
    if (max > min)
  ...
  /// <returns></returns>
  [MethodImpl(MethodImplOptions.AggressiveInlining)]
  public double[] RngCryptoDouble(int size)
  {
  ...
  /// <returns>Datatype Double</returns>
  [MethodImpl(MethodImplOptions.AggressiveInlining)]
  public double[] RngCryptoDouble(int size, double max)
  {
  ...
  /// <returns>Datatype Double</returns>
  [MethodImpl(MethodImplOptions.AggressiveInlining)]
  public double[] RngCryptoDouble(int size, double min, double max)
  {
    var result = new double[size];
  ...
  /// <param name="dest">Buffer</param>
  [MethodImpl(MethodImplOptions.AggressiveInlining)]
  public void FillCryptoDoubles(double[] dest)
  {
  ...
  /// <param name="max">Upper Limit</param>
  [MethodImpl(MethodImplOptions.AggressiveInlining)]
  public void FillCryptoDoubles(double[] dest, double max)
  {
  ...
  /// <exception cref="ArgumentOutOfRangeException"></exception>
  [MethodImpl(MethodImplOptions.AggressiveInlining)]
  public void FillCryptoDoubles(double[] dest, double min, double max)
  {
    if (max > min)
    {
  ...
  [MethodImpl(MethodImplOptions.AggressiveInlining)]
  public void Shuffle<T>(T[] items) => this.Shuffle(items, 0, -1);
  ...
  [MethodImpl(MethodImplOptions.AggressiveInlining)]
  public void Shuffle<T>(IList<T> items) => this.Shuffle(items, 0, -1);
