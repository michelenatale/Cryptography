...
public class BobLMS : IDisposable
{
  ...
  public LmsParam Parameter { get; private set; } = LmsParam.lms_sha256_h5_w1;
  ...
  public BobLMS(LmsParam parameter)
  {
    this.Parameter = parameter;

    var generator = BcPqcServices.ToLmsKeyGenerationParameter(
      this.Parameter, this.Rand);
    ...
    ReadOnlySpan<byte> message)
  {
    ...
    var pubkey = LmsPublicKeyParameters
      .GetInstance(pubkeyalice.ToArray());
  ...
  public static LmsPublicKeyParameters ToPubKey(
    byte[] pubkey, LmsParameters parameter) =>
