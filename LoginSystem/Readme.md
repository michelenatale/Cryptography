...
LoginSystem is a simple project that shows how to perform a secure local login for your application. It is based on the **Winform-Mvvm-Design** Pattern and UserControls.
