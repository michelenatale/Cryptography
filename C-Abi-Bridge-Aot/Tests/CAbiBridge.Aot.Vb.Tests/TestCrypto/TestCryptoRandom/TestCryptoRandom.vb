  ...
  Partial Class CryptoRandomTest
    ...
    Private Shared Sub TestRngCryptoBytesAot(rounds As Int32)
      ...
      For i = 0 To rounds - 1
        ...
        Dim err = RngCryptoBytesAot(size, out_ptr)
        AssertError(err)
      ...
      For i = 0 To rounds - 1
        ...
        Dim err = FillCryptoBytesAot(bytes, bytes.Length)
        AssertError(err)
    ...
    Private Shared Sub TestRngCryptoBoolAot(rounds As Int32)
      ...
      For i = 0 To rounds - 1
        Dim size = rand.[Next](128, 512)
        err = RngCryptoBoolAot(size, out_ptr)
        AssertError(err)
    ...
    Private Shared Sub TestNextCryptoInt32Aot(rounds As Int32)
      ...
      Dim sw = Stopwatch.StartNew()
      For i = 0 To rounds - 1
        Dim result = NextCryptoInt32Aot(err)
        AssertError(err)
      ...
      For i = 0 To rounds - 1
        Dim max = rand.[Next]()
        Dim result = NextCryptoInt32MaxAot(max, err)
        AssertError(err)
      ...
      For i = 0 To rounds - 1
        ...
        Dim result = NextCryptoInt32MinMaxAot(min, max, err)
        AssertError(err)
    ...
    Private Shared Sub TestRngCryptoInt32Aot(rounds As Int32)
      ...
      For i = 0 To rounds - 1
        Dim size = rand.[Next](128, 512)
        Dim err = RngCryptoInt32Aot(size, out_ptr)
        AssertError(err)
      ...
      For i = 0 To rounds - 1
        Dim max = rand.[Next]()
        Dim size = rand.[Next](128, 512)
        Dim err = RngCryptoInt32MaxAot(size, max, out_ptr)
        AssertError(err)
      ...
      For i = 0 To rounds - 1
        ...
        Dim err = RngCryptoInt32MinMaxAot(size, min, max, out_ptr)
        AssertError(err)
    ...
    Private Shared Sub TestNextCryptoInt64Aot(rounds As Int32)
      ...
      For i = 0 To rounds - 1
        Dim result = NextCryptoInt64Aot(err)
        AssertError(err)
      ...
      For i = 0 To rounds - 1
        ...
        Dim result = NextCryptoInt64MaxAot(max, err)
        AssertError(err)
      ...
      For i = 0 To rounds - 1
        ...
        Dim result = NextCryptoInt64MinMaxAot(min, max, err)
        AssertError(err)
    ...
    Private Shared Sub TestRngCryptoInt64Aot(rounds As Int32)
      ...
      For i = 0 To rounds - 1
        Dim size = rand.[Next](128, 512)
        Dim err = RngCryptoInt64Aot(size, out_ptr)
        AssertError(err)
      ...
      For i = 0 To rounds - 1
        Dim max = rand.[Next]()
        Dim size = rand.[Next](128, 512)
        Dim err = RngCryptoInt64MaxAot(size, max, out_ptr)
        AssertError(err)
      ...
      For i = 0 To rounds - 1
        ...
        Dim err = RngCryptoInt64MinMaxAot(size, min, max, out_ptr)
        AssertError(err)
    ...
    Private Shared Sub TestNextCryptoDoubleAot(rounds As Int32)
      ...
      For i = 0 To rounds - 1
        Dim result = NextCryptoDoubleAot(err)
        AssertError(err)
      ...
      For i = 0 To rounds - 1
        Dim max = rand.NextInt64()
        Dim result = NextCryptoDoubleMaxAot(max, err)
        AssertError(err)
      ...
      For i = 0 To rounds - 1
        ...
        Dim result = NextCryptoDoubleMinMaxAot(min, max, err)
        AssertError(err)
    ...
    Private Shared Sub TestRngCryptoDoubleAot(rounds As Int32)
      ...
      For i = 0 To rounds - 1
        Dim size = rand.[Next](128, 512)
        Dim err = RngCryptoDoubleAot(size, out_ptr)
        AssertError(err)
      ...
      For i = 0 To rounds - 1
        Dim max = rand.NextInt64()
        Dim size = rand.[Next](128, 512)
        Dim err = RngCryptoDoubleMaxAot(size, max, out_ptr)
        AssertError(err)
      ...
      For i = 0 To rounds - 1
        Dim size = rand.[Next](128, 512)
        Dim min As Int64 = CLng(Int64.MaxValue / 3), max = min * 2
        Dim err = RngCryptoDoubleMinMaxAot(size, min, max, out_ptr)
        AssertError(err)
    ...
    Private Shared Sub TestNextCryptoSingleAot(rounds As Int32)
      ...
      Dim err As CError = Nothing
      For i = 0 To rounds - 1
        Dim result = NextCryptoSingleAot(err)
        AssertError(err)
      ...
      For i = 0 To rounds - 1
        Dim max = rand.NextInt64()
        Dim result = NextCryptoSingleMaxAot(max, err)
        AssertError(err)
      ...
      For i = 0 To rounds - 1
        Dim min As Int64 = CLng(Int64.MaxValue / 3), max = 2 * min
        Dim result = NextCryptoSingleMinMaxAot(min, max, err)
        AssertError(err)
    ...
    Private Shared Sub TestRngCryptoSingleAot(rounds As Int32)
      ...
      For i = 0 To rounds - 1
        Dim size = rand.[Next](128, 512)
        Dim err = RngCryptoSingleAot(size, out_ptr)
        AssertError(err)
      ...
      For i = 0 To rounds - 1
        Dim max = rand.NextInt64()
        Dim size = rand.[Next](128, 512)
        Dim err = RngCryptoSingleMaxAot(size, max, out_ptr)
        AssertError(err)
      ...
      For i = 0 To rounds - 1
        Dim size = rand.[Next](128, 512)
        Dim min As Int64 = CLng(Int64.MaxValue / 3), max = min * 2
        Dim err = RngCryptoSingleMinMaxAot(size, min, max, out_ptr)
        AssertError(err)
    ...
    Private Shared Sub TestNextCryptoDecimalAot(rounds As Int32)
      ...
      Dim err As CError = Nothing
      For i = 0 To rounds - 1
        Dim result = NextCryptoDecimalAot(err)
        AssertError(err)
      ...
      For i = 0 To rounds - 1
        Dim max = rand.NextInt64()
        Dim result = NextCryptoDecimalMaxAot(max, err)
        AssertError(err)
      ...
      For i = 0 To rounds - 1
        Dim min As Int64 = CLng(Int64.MaxValue / 3), max = 2 * min
        Dim result = NextCryptoDecimalMinMaxAot(min, max, err)
        AssertError(err)
    ...
    Private Shared Sub TestRngCryptoDecimalAot(rounds As Int32)
      ...
      For i = 0 To rounds - 1
        Dim size = rand.[Next](128, 512)
        Dim err = RngCryptoDecimalAot(size, out_ptr)
        AssertError(err)
      ...
      For i = 0 To rounds - 1
        ...
        Dim size = rand.[Next](128, 512)
        Dim err = RngCryptoDecimalMaxAot(size, max, out_ptr)
        AssertError(err)
      ...
      For i = 0 To rounds - 1
        ...
        Dim err = RngCryptoDecimalMinMaxAot(size, min, max, out_ptr)
        AssertError(err)
