...
Namespace michele.natale.Tests
  Partial Class CryptoChaCha20Poly1305Test
    Public Shared Sub TestChaCha20Poly1305Bytes(rounds As Int32)
      Console.Write($"{NameOf(TestChaCha20Poly1305Bytes)}Aot: ")
      ...
      For i As Int32 = 0 To rounds - 1
        ...
        Using key = New UsIPtr(Of Byte)(
          ...
          Dim nonce = RngBytes(NetServicesCrypto.CHACHA_POLY_NONCE_SIZE)
          Dim tag = New Byte(NetServicesCrypto.CHACHA_POLY_TAG_SIZE - 1) {}

          size = rand.[Next](NetServicesCrypto.CHACHA_POLY_MIN_PLAIN_SIZE,
    ...
    Public Shared Sub TestChaCha20Poly1305BytesStress()
      Console.Write($"{NameOf(TestChaCha20Poly1305BytesStress)}Aot: ")
