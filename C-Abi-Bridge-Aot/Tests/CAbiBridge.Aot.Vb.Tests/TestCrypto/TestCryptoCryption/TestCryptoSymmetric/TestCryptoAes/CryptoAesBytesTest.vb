...
Namespace michele.natale.Tests
  Partial Class CryptoAesTest
    Public Shared Sub TestAesBytes(rounds As Int32)
      Console.Write($"{NameOf(TestAesBytes)}Aot: ")
      ...
      For i As Int32 = 0 To rounds - 1
        ...
        Using key = New UsIPtr(Of Byte)(
          Rfc2898DeriveBytes.Pbkdf2(
            ...
            outputLength:=NetServicesCrypto.AES_KEY_SIZE))

          Dim nonce = RngBytes(NetServicesCrypto.AES_IV_SIZE)
          Dim tag = New Byte(NetServicesCrypto.AES_TAG_SIZE - 1) {}

          size = rand.[Next](NetServicesCrypto.AES_MIN_PLAIN_SIZE,
            NetServicesCrypto.AES_MAX_PLAIN_SIZE)
    ...
    Public Shared Sub TestAesBytesStress()
      Console.Write($"{NameOf(TestAesBytesStress)}Aot: ")
